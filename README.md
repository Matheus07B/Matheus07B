...
- **Development**:  
  Interactive interfaces with **HTML, CSS, JavaScript**, and robust applications using **Python** and **NodeJs**.  

- **Databases**:  
  Managing and manipulating data with **SQL, MySQL, SQLite3, Postgres**.  
